...
static const struct command user_cmd_float_test = {
	.cmd = "float_test",
	.handler = user_cmd_float_handler,
	.priv = NULL,
};

int user_cmd_float_test_init()
{
	register_command(&user_cmd_float_test);

	return 0;
}

APP_COMMAND_REGISTER(float_test, user_cmd_float_test_init);
